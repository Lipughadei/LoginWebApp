            ...
            steps {
                script {
                    withCredentials([aws(accessKeyVariable: 'AWS_ACCESS_KEY_ID', credentialsId: 'aws-credential', secretKeyVariable: 'AWS_SECRET_ACCESS_KEY')]) {
                        ...
                        sh 'sudo docker build -t lipughadei/tomcat:v1.0 -f Dockerfile-tomcat ./Docker/Dockerfile-tomcat'
                        sh 'sudo docker build -t lipughadei/mysql:v1.0 -f Dockerfile-mysql ./Docker/Dockerfile-mysql'
